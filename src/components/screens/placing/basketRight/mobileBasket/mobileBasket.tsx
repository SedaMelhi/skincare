...
const MobileBasket: FC<{ basket: IOrder | null }> = ({ basket }) => {
  const arr: IOrderBasket[] | [] = basket
    ? Object.values(basket.cartItems)
    : [];
  return (
    <div className={style.basket_mobile}>
      <div
        className={style.basket__wrap}
        style={arr.length === 0 ? { height: "310px" } : {}}
      >
              ...
              <div className={style.padding}>
                <div className={style.content}>
                  {arr.length === 0 ? (
                    ...
                    arr.map(
                      ({ name, cartId, price, value, picture, parentId }) => (
                        <Link
              ...
              {arr.length !== 0 && (
                <div className={style.footer}>
                  ...
                  <div className={style.line}>
                    ...
                    <div className={style.border}></div>
                    <div className={style.all__price}>
                      {basket && basket.basket.price} ₽
                    </div>
                  </div>
                  <div className={style.promocodes}>
                    <div
                      className={
                        style.promocode__wrap + " " + style.promocode__first
                      }
                    >
                      <input
                        type="text"
